    ...
    <section id="about" className="bg-black py-20 px-4 md:px-6">
      <div className="bg-[#101010] rounded-2xl md:rounded-[2rem] max-w-6xl mx-auto px-6 py-16 md:py-24 lg:py-32 flex flex-col items-center justify-center text-center">
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <AnimatedLetter className="text-gray-400 text-xs sm:text-sm md:text-base leading-relaxed text-justify sm:text-center">
            From architecting the open OOH advertising network <strong>FlexConnect</strong>, to building the AI-powered electrical design platform <strong>SmartWiring AI</strong>, we don't just build websites—we engineer complete end-to-end ecosystems that drive real-world impact.
          </AnimatedLetter>
        </div>
